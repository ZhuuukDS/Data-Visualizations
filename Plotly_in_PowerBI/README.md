...
<img src = 'pbiviz.png' width=600>
4. Now you can go to the project folder and create a new folder `pbi_test_visual` for a sample visual `rhtml` template
<blockquote> pbiviz new pbi_test_visual -t rhtml </blockquote>
you'll see something like this:
<img src = 'new_visual.png' width=600>
